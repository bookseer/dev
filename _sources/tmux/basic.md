...
Чтобы закрыть окно, можно либо ввести `exit` в приглашение командной сторки в окне, либо использовать {bdg-dark}`PREFIX`
...
Закрытие панели происходит так же, как и закрытие сеанса или окна tmux: нужно просто ввести `exit` в пенель, которую необходимо закрыть.
...
Команды tmux можно выполнять кдвумя способами: из самого терминала или из области команд в строке состояния tmux.
...
:::{note}
`:` обозначает символ приглаашения ко вводу команд. Его набирать не нужно.
:::
...
Командный режим может истользоваться для создания новых окон, новых панелей, новых сеансов или для установки других параметров окружения.
...
## Получение справочной инфориации
