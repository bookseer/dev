...
Если используемый терминал поддерживает упрваление мышью, то можно указать tmux, как обрабатывать определенные события
мыши.
Например, ногда полезно иметь возможность прокручивать буфер терминала колесиком мыши или выбирать окна и панели.
Это особенно особенно актуально для начинающих пользователей tmux.
...
`display-message` или `display`             | Отображает данный текст в строке состоятия.
